...
var textIndicationOfAudioPlayingStatus = document.getElementsByClassName("text-indication-of-audio-playing-status")[0];
...
languageToggleButton.addEventListener("change", function () {
    if (languageToggleButton.checked) {
...
/** Set the text indicator of the audio being playing in the background */
function setTextIndicatorOfAudioPlayingStatus(text) {
    textIndicationOfAudioPlayingStatus.textContent = text;
}
...
function playAudio(recorderAudioAsBlob) {
    ...
    data.append('file', recorderAudioAsBlob);

    // Display text indicator of having the audio play in the background
    displayTextIndicatorOfAudioPlaying();

    // Set text indicator of having the audio listening in the background
    setTextIndicatorOfAudioPlayingStatus(textOfAudioPlayingStatus[0]);
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            audioElementSource.src = data.result;
            audioElementSource.type = data.type;
            ...
            // Set text indicator of having the audio playing in the background
            setTextIndicatorOfAudioPlayingStatus(textOfAudioPlayingStatus[1]);
        }
    });
}
